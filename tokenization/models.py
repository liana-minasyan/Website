...
class Token(models.Model):
  ...
  sentence = models.ForeignKey(Sentence, on_delete=models.DO_NOTHING)
  ...
  selected_tag = models.ForeignKey('tokenization.Word', related_name='selected_tag', blank=True, null=True, on_delete=models.DO_NOTHING)
...
class Sconj(models.Model):
  POS = 'sconj'
  parent = models.OneToOneField('tokenization.Word', blank=True, null=True, editable=False, on_delete=models.DO_NOTHING)
  lemma = lemma
  abbr = abbr
  poss = poss
  echo = echo
...
class Noun(models.Model):
  POS = 'noun'
  parent = models.OneToOneField('tokenization.Word', related_name='n_parent', blank=True, null=True, editable=False, on_delete=models.DO_NOTHING)
  lemma = lemma
...
class Verb(models.Model):
  POS = 'verb'
  parent = models.OneToOneField('tokenization.Word', related_name='v_parent', blank=True, null=True, editable=False, on_delete=models.DO_NOTHING)
  lemma = lemma
  abbr = abbr
  poss = poss
  echo = echo
